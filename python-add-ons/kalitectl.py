...
# KALITE_HOME = os.path.join(os.path.expanduser("~"), ".kalite")   #instead of creating the dir in the root level, 
#puting that dir in the current working dir solves the unrooted privilege issue on Android
