...
public class GlobalValues {
    ...
    public void setCheck(boolean b, String command) {
        checked = b;
    ...
    public void setPythonExitCode(int code) {
        ...
        Log.d(GlobalConstants.LOG_TAG, "elielieli: GlobalValues "
                + python_exit_code);
    }
    ...
    public static synchronized GlobalValues getInstance() {
        // if (context == null) {
        // throw new
        // IllegalArgumentException("Impossible to get the instance. This class must be initialized before");
        // }
